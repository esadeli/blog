...
export default {
  ...
  methods: {
    loginToSite () {
      ...
      axios({
        method: 'POST',
        url: 'https://blogserver.efratsadeli.online/users/login',
        data: {
          email: self.email,
        ...
        .then(response => {
          ...
          axios({
            method: 'GET',
            url: 'https://blogserver.efratsadeli.online/users/details',
            headers: {
              token: jwttoken
            }
          })
    ...
    registerToSite () {
      ...
      axios({
        method: 'POST',
        url: 'https://blogserver.efratsadeli.online/users/register',
        data: {
