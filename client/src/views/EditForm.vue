        ...
        <div class="col-md-15 box">
            <div class="details">
                ...
                <form>
                    ...
                    <button type="button" class="btn btn-primary" v-on:click= "editArticle()">Edit Article</button>
                </form>
                <br/>
                <br/>
            </div>
...
export default {
  ...
  methods: {
    editArticle: function () {
      ...
      axios({
        method: 'PUT',
        url: `https://blogserver.efratsadeli.online/articles/edit/${self.articleid}`,
        headers: {
          token: self.token
        },
        data: {
  ...
  created () {
    ...
    axios({
      method: 'GET',
      url: `https://blogserver.efratsadeli.online/articles/details/${self.articleid}`
    })
      .then(article => {
